...
2. 時間帯ラベルの厳禁: 『朝日』『夕日』『夕焼け』『夕暮れ』『夕映え』『夕景』『夜景』『黄昏』などの直接的な時間帯を示す単語・ラベルの使用は【一切厳禁】です。安易な時間帯ラベルに頼らず、画面に現れている光の角度、質感、明暗のコントラスト、グラデーションの美しさを表現してください。
3. 人物の「しぐさ」の読解: 画面内に人物がある場合、単なる「構成要素（点）」ではなく、その「視線の先」「歩みの速さ」「佇まい」から立ち上がる情緒を優先的に読み解き、物語の起点（線）として扱ってください。
...
4. 【物語としての人物】: 人物の「しぐさ」や「様子」から、その前後の時間の流れを推論して言語化してください。偶然の写り込みであっても、その人が入り込むことで風景の価値がどう更新されたかという新たな意味を提案してください。
