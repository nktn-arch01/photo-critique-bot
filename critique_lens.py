...
SELF_LENS = CritiqueLens(
    ...
    score_axes=(
        ...
        _axis(
            ...
            # 表示名は感情の陰影。採点は光・明暗・トーン・反射や写り込みが生む感情のニュアンス（観測可能）に固定。
            "観察対象: 光線の強弱・明暗の幅、ハイライトと影の関係、色温度やトーンの偏り、反射や写り込み、そこから読める感情のニュアンス。"
            "アンカー: ★1=トーンによる感情の動きが弱い ★3=光や陰影が気分をはっきり伝える ★5=光や陰影が感情表現の主軸。"
