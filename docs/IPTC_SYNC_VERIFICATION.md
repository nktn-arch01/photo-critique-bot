...
実装: [`iptc_rating_io.py`](../iptc_rating_io.py)（T1）、[`library_unit.py`](../library_unit.py)（T2）。次は [`R1A_IMPLEMENTATION_BREAKDOWN.md`](R1A_IMPLEMENTATION_BREAKDOWN.md) の **T3** 以降。
