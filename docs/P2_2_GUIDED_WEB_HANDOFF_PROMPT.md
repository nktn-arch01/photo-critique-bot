...
1. **Guided の単独起動・終了は完了**（オーナー宣言 2026-08-30。A1 / A2 / A4 / A5 PASS）。Dock / WebKit / applet / 「本物の Mac アプリ」作業は再開しない
2. 任意の P5（永続 `session.json`）— 求められない限り着手しない
3. 見た目の磨き — 求められない限り着手しない
4. Mac チェックリストの PASS 記入はオーナー。4f Cancel は **PASS（2026-08-29）**。3e / 3f / 4b / 5 は **未確認**
