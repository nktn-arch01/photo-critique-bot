...
2. 時間帯ファクト（{time_zone_fact}）を尊重し、朝日と夕日の誤解釈が起きないように正しい時間帯に沿ったタイトルと要約を作成してください。
...
"""
    ...
    # =========================================================
    # Phase 2: 本文【1】〜【7】生成 (#カメラ_ #レンズ_ タグの生成を厳格指定)
    # =========================================================
...
## 【7. 自動タグ】
#カメラ_{camera_tag} #レンズ_{lens_tag} (ここに写真の被写体・光・質感・空気感に応じた動的なハッシュタグを8〜12個続けて出力してください)
"""
