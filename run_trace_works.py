...
Usage:
  ...
  python3 run_trace_works.py --dir /path/to/Works --force
  python3 run_trace_works.py --dir /path/to/Works --mode compact --theme light
...
from trace_from_works import TraceConfig, TraceProgress, WorksTraceRunner
